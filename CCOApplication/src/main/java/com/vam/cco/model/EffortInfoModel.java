...
public class EffortInfoModel implements Serializable {
    ...
    public Long getEffortDetailId() { return effortDetailId; }
    public void setEffortDetailId(Long effortDetailId) { this.effortDetailId = effortDetailId; }
}
