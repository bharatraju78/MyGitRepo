...
public class EmployeeCompensation implements Serializable {
	...
	@Transient
	List<EmployeeCompensation> employeeCompensations;
	...
	public String toString() {
		return "EmployeeCompensation [id=" + id + ", employeeId=" + employeeId + ", ctc=" + ctc + ", startDate="
				+ startDate + ", endDate=" + endDate + ", comments=" + comments + ", createdBy=" + createdBy
				+ ", modifiedBy=" + modifiedBy + ", createdDate=" + createdDate + ", modifiedDate=" + modifiedDate
				+ ", status=" + status + ", actionFrom=" + actionFrom + ", requestType=" + requestType + ", requestId="
				+ requestId + ", employeeCompensations=" + employeeCompensations + "]";
	}
