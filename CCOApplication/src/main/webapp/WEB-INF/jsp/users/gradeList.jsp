...
<body>
    ...
    <div class="container mt-4">
        ...
        <a href="${pageContext.request.contextPath}/admin/grades/add" class="btn btn-primary mb-2">Add New Grade</a>
          ...
          <table class="table table-bordered">
            ...
            <c:forEach var="grade" items="${grades}">
                <tr>
                    ...
                    <td>${grade.modifiedBy}</td>
                    <td>
                    	<fmt:formatDate value="${grade.createdDate}" pattern="dd-MM-yyyy" var="createdDate" />
                    	${createdDate}
                    </td>
                    <td>
                    	<fmt:formatDate value="${grade.modifiedDate}" pattern="dd-MM-yyyy" var="modifiedDate" />
                    	${modifiedDate}
                    </td>
                    <td>
                        <a href="${pageContext.request.contextPath}/admin/grades/edit/${grade.gradeId}" class="btn btn-sm btn-warning">Edit</a>
                        <a href="${pageContext.request.contextPath}/admin/grades/delete/${grade.gradeId}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
