...
<body>
    ...
    <div class="container mt-4">
        ...
        <a href="${pageContext.request.contextPath}/admin/designations/add" class="btn btn-primary mb-2">Add New Designation</a>
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="designation" items="${designations}">
                <tr>
                    ...
                    <td>
                    	<fmt:formatDate value="${designation.createdDate}" pattern="dd-MM-yyyy" var="createdDate" />
                    	${createdDate}
                    </td>
                    <td>
                    	<fmt:formatDate value="${designation.modifiedDate}" pattern="dd-MM-yyyy" var="modifiedDate" />
                    	${modifiedDate}
                    </td>
                    <td>
                        <a href="${pageContext.request.contextPath}/admin/designations/edit/${designation.designationId}" class="btn btn-sm btn-warning">Edit</a>
                        <a href="${pageContext.request.contextPath}/admin/designations/delete/${designation.designationId}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
