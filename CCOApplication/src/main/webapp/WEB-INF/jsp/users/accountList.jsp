...
<body>
    ...
    <div class="container mt-4">
        ...
        <a href="${pageContext.request.contextPath}/admin/account/add" class="btn btn-primary mb-2">Add New Account</a>
                ...
                <tr>
                    ...
                    <td>
                    	<c:if test="${empty fromAction}">
	                        <a href="${pageContext.request.contextPath}/admin/account/edit/${account.accountId}" class="btn btn-sm btn-warning">Edit</a>
	                        <a href="${pageContext.request.contextPath}/admin/account/delete/${account.accountId}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                    	</c:if>
                    	<c:if test="${not empty fromAction}">
                        <a href="${pageContext.request.contextPath}/admin/map-associates/accountDetails/${account.accountId}" class="btn btn-sm btn-warning" title="Map">
