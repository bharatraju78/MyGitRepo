...
<body>
    ...
    <div class="container mt-4">
        ...
        <a href="${pageContext.request.contextPath}/admin/department/add" class="btn btn-primary mb-2">Add New Department</a>
        <c:if test="${empty departmentModels }">
            <div class="alert alert-info">
                No departments found.
            </div>
        </c:if>
        <c:if test="${not empty departmentModels }">    
        <table class="table table-bordered">
            ...
            <tbody>
            <c:forEach var="department" items="${departmentModels}">
                <tr>
                    ...
                    <td>
                    	<fmt:formatDate value="${department.createdDate}" pattern="dd-MM-yyyy" var="createdDate" />
                    	${createdDate}
                    </td>
                    <td>
                    	<fmt:formatDate value="${department.modifiedDate}" pattern="dd-MM-yyyy" var="modifiedDate" />
                    	${modifiedDate}
                    </td>
                    <td>
                        <a href="${pageContext.request.contextPath}/admin/department/edit/${department.departmentId}" class="btn btn-sm btn-warning">Edit</a>
                        <a href="${pageContext.request.contextPath}/admin/department/delete/${department.departmentId}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
