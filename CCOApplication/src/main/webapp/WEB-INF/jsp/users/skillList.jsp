...
<body>
    ...
    <div class="container mt-4">
        ...
        <a href="${pageContext.request.contextPath}/admin/skills/add" class="btn btn-primary mb-2">Add New Skill</a>
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="skill" items="${skills}">
                <tr>
                    ...
                    <td>
                    	<fmt:formatDate value="${skill.createdDate}" pattern="dd-MM-yyyy" var="createdDate" />
                    	${createdDate}
                    </td>
                    <td>
                    	<fmt:formatDate value="${skill.modifiedDate}" pattern="dd-MM-yyyy" var="modifiedDate" />
                    	${modifiedDate}
                    </td>
                    <td>
                        <a href="${pageContext.request.contextPath}/admin/skills/edit/${skill.skillId}" class="btn btn-sm btn-warning">Edit</a>
                        <a href="${pageContext.request.contextPath}/admin/skills/delete/${skill.skillId}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
