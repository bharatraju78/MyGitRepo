...
<body>
    ...
    <div class="container mt-4">
        <h2>${skill.skillId == null ? 'Add' : 'Edit'} Skill</h2>
        <form action="${pageContext.request.contextPath}/admin/skills/skill-save" method="post">
            <input type="hidden" name="skillId" value="${skill.skillId}" />
            <input type="hidden" name="createdBy" value="${skill.createdBy}" />
            <input type="hidden" name="modifiedBy" value="${skill.modifiedBy}" />
            <input type="hidden" name="createdDate" value="${skill.createdDate}" />
            <input type="hidden" name="modifiedDate" value="${skill.modifiedDate}" />
            <div class="row">
                <div class="form-group">
                    <label class="col-sm-2" for="skillName">Skill Name</label>
                    <div class="col-lg-4">
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    ...
                    <a href="skill-list" class="btn btn-secondary">Cancel</a>
                </div>
            </div>
        </form>
    </div>
