...
<body>
    ...
    <div class="container mt-4">
        ...
        <a href="${pageContext.request.contextPath}/admin/labels/add" class="btn btn-primary mb-2">Add New Label</a>
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="label" items="${labels}">
                <tr>
                    ...
                    <td>${label.modifiedBy}</td>
                    <td>
                    	<fmt:formatDate value="${label.createdDate}" pattern="dd-MM-yyyy" var="createdDate" />
                    	${createdDate}
                    </td>
                    <td>
                    	<fmt:formatDate value="${label.modifiedDate}" pattern="dd-MM-yyyy" var="modifiedDate" />
                    	${modifiedDate}
                    </td>
                    <td>
                        <a href="${pageContext.request.contextPath}/admin/labels/edit/${label.labelId}" class="btn btn-sm btn-warning">Edit</a>
                        <a href="${pageContext.request.contextPath}/admin/labels/delete/${label.labelId}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
